...
# borrowed from https://github.com/cs230-stanford/cs230-code-examples/blob/master/pytorch/vision/
class Params():
...
def calculate_accuracy(output, label):
    ...
    return torch.true_divide((output==label).sum(dim=0), output.size(0)).item()
